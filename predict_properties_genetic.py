...
def predict_properties(df):
	...
	with tf.Session() as sess:
		...
		normalized_df = normalize(df, compound_data)
		new_er = normalized_df[['er1', 'er2', 'V1', 'V2']]
		new_Qf = normalized_df[['Qf1', 'Qf2', 'V1', 'V2']]
		new_Tcf = normalized_df[['Tcf1', 'Tcf2', 'V1', 'V2']]
		...
		# print denormalized_outputs[:,0].reshape(-1,1)
		return predicted_outputs_pd
